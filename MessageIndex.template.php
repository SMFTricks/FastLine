...
function template_main()
{
	...
	<div class="tborder topic_table" id="messageindex">
		...
		foreach ($context['topics'] as $topic)
		{
			...
			if(!empty($settings['separate_sticky_locked']))
			{
					...
					echo '
						<tr class="catbg">
							<td colspan="', empty($options['display_quick_mod']) ? '7' : '8', '">
								<strong>', $txt['sh_sticky_topic'], '</strong>
							</td>
						</tr>
					';
					$stickybar = true;
				...
				elseif (!$topic['is_sticky'] && $stickybar && !$normalbar)
				{
					echo '
						<tr class="catbg">
							<td colspan="', empty($options['display_quick_mod']) ? '7' : '8', '">
								<strong>', $txt['sh_normal_topic'], '</strong>
							</td>
						</tr>
					';
					$normalbar = true;
			...
			echo '
					...
					<td class="stats ', $color_class, '">
						<span class="replies_colorize">', $topic['replies'], ' ', $txt['replies'], '</span>
						<br />
						<span class="views_colorize">', $topic['views'], ' ', $txt['views'], '</span>
					</td>
