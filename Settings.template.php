...
function template_settings()
{
	...
	'',
		...
		array( 
            'id' => 'sh_cbox',
            'label' => $txt['sh_cbox_enable'],
            'type' => 'checkbox',
            'description' => $txt['sh_cbox_desc'],  
		),
		array( 
            'id' => 'sh_cbox_t',
            'label' => $txt['sh_cbox_t'],
		...
		array( 
            'id' => 'sh_cbox_cont',
            'label' => $txt['sh_cbox_cont'],
            'type' => 'textarea',
        ),
	'',
		array(
			'id' => 'separate_sticky_locked',
			'label' => $txt['separate_sticky_locked'],
			'description' => $txt['separate_sticky_locked_desc'],
			'default' => false,
		),
	'',
		array(
	...
	'',
		...
		array(
			'id' => 'link_top1_url',
			'label' => $txt['link_top_url'],
			'description' => $txt['link_top_desc'],
			'type' => 'text',
		),
		array(
			'id' => 'link_top2',
