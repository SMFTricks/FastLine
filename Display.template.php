...
function template_main()
{
	...
	// The indicators... Some buttons.
	if ($context['is_locked'] && empty($context['is_sticky']))
	echo '
		<div class="ind_button">', $txt['locked_topic'], '</div><br class="clear" />';
	
	elseif ($context['is_sticky'] && empty($context['is_locked']))
	echo '
		<div class="ind_button">', $txt['sticky_topic'], '</div><br class="clear" />';
	
	elseif ($context['is_locked'] && $context['is_sticky'])
	echo '
		<div class="ind_button">', $txt['locked_topic'], '</div>
		<div class="ind_button">', $txt['sticky_topic'], '</div>
		<br class="clear" />';
	...
	// If there are no replies... Let's tell them
	if ($context['num_replies'] == 0 && !$context['is_locked'])
	{
			echo '
				<br class="clear" />
				<div class="any_com">', $txt['sh_any_com'], '</div>';
	}
	elseif ($context['is_locked'])
	{
			echo '
				<br class="clear" />
				<div class="any_com_locked">', $txt['sh_topic_locked'], '</div>';
	}
